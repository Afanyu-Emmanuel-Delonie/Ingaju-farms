          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="flex flex-col gap-3">
              ...
              <div className="relative h-36 w-full overflow-hidden rounded-xl">
                <Image src="/images/milk.jpgg" alt="Organic manure processing" fill sizes="25vw" className="object-cover" />
              </div>
            </div>
            <div className="flex flex-col gap-3">
              <div className="relative h-36 w-full overflow-hidden rounded-xl">
                <Image src="/images/bg-3.png" alt="Dairy barn at Ingaju Farms" fill sizes="25vw" className="object-cover" />
              </div>
              <div className="relative h-56 w-full overflow-hidden rounded-xl sm:h-64">
