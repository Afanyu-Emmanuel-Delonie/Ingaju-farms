        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center lg:gap-24">
          ...
          >
            ...
            <h2 className="font-heading text-3xl font-bold leading-tight text-[#1C2321] sm:text-4xl">
             Circular. Integrated. Zero Waste. <span className="text-[#3A7D5A]">Zero Waste.</span>
            </h2>
            <p className="mt-5 text-[15px] font-body leading-relaxed text-[#6B6259] max-w-lg">
              Conventional farms depend on costly external inputs — synthetic fertilizers, imported feed, and chemical treatments. Ingaju operates as a closed production loop where every output from one stage becomes a productive input for the next, eliminating waste and reducing costs at every point.
            </p>
