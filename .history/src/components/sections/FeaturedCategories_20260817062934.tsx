    ...
    <section className="w-full bg-white">
      <div className="container-pad py-20">
        ...
        <div className="mt-10 grid grid-cols-1 gap-4">
          ...
          <a
            href="/products/dairy"
            className="group relative block h-[38rem] w-full overflow-hidden rounded-2xl sm:h-[32rem]"
          >
            <Image
              ...
              fill
              sizes="100vw"
              className="object-cover object-[20%_center] transition-transform duration-500 group-hover:scale-105 sm:object-center"
            />
