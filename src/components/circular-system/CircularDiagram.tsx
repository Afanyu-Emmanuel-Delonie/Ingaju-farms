    ...
    <section id="the-loop" className="w-full bg-[#FAF8F5]">
      <div className="container-pad py-24">
        ...
        <div className="text-center mb-16">
          <p className="text-sm font-body font-semibold tracking-widest uppercase text-[#2E4F41] mb-3">The Loop</p>
          <h2 className="font-heading text-3xl font-bold text-[#1C2321] sm:text-4xl">
            How the Circular System <span className="text-[#2E4F41]">Works</span>
          </h2>
        ...
        <div className="flex justify-center items-center">
          ...
          >
            ...
            >
              <svg className="mb-1 text-[#2E4F41]" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z"/>
                <path d="M2 21c0-3 1.85-5.36 5.08-6C9.5 14.52 12 13 13 12"/>
              </svg>
              <p className="font-heading text-base font-bold text-[#2E4F41]">Ingaju</p>
              <p className="mt-0.5 text-[9px] font-body font-semibold uppercase tracking-widest text-[#2E4F41]/60 leading-tight">
            ...
            {NODES.map(({ position, img, alt, label, desc }) => (
              ...
              >
                <div className="overflow-hidden rounded-xl bg-white shadow-lg border border-[#1C2321]/5">
                  ...
                  <div className="bg-[#2E4F41] px-2 py-1.5 text-center">
            ...
            <svg className="absolute inset-0 w-full h-full pointer-events-none" viewBox="0 0 580 580" fill="none">
              <defs>
                <marker id="arrow" markerWidth="10" markerHeight="7" refX="9" refY="3.5" orient="auto">
                  <polygon points="0 0, 10 3.5, 0 7" fill="#2E4F41" />
                </marker>
              </defs>
              <motion.path d="M 375 130 Q 465 185 490 250" stroke="#2E4F41" strokeWidth="4" fill="none" markerEnd="url(#arrow)" strokeDasharray="5 4" variants={arrowVariants} />
              <motion.path d="M 490 330 Q 465 395 375 450" stroke="#2E4F41" strokeWidth="4" fill="none" markerEnd="url(#arrow)" strokeDasharray="5 4" variants={arrowVariants} />
              <motion.path d="M 205 450 Q 115 395 90 330" stroke="#2E4F41" strokeWidth="4" fill="none" markerEnd="url(#arrow)" strokeDasharray="5 4" variants={arrowVariants} />
              <motion.path d="M 90 250 Q 115 185 205 130" stroke="#2E4F41" strokeWidth="4" fill="none" markerEnd="url(#arrow)" strokeDasharray="5 4" variants={arrowVariants} />
            </svg>
          </motion.div>
        </div>
      </div>
