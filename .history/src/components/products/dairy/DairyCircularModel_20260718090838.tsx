        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center lg:gap-16">
          ...
          <div>
            ...
            <p className="mt-4 text-[15px] font-body leading-relaxed text-[#6B6259]">
              Every element of our dairy operation is monitored and integrated
              into a zero-waste loop. By combining effective management with
              continuous data collection, we optimize resource
              conversion maximizing operational efficiency and predictability
              season after season.
            </p>
