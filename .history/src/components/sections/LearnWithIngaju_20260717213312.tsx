...
const STEPS = [
  { 
    number: "01", 
    title: "Forage Production", 
    desc: "We cultivate high-quality, climate-smart fodder on-site, eliminating reliance on costly commercial feed." 
  },
  { 
    number: "02", 
    title: "Herd Management", 
    desc: "Cattle are raised under strict welfare and health protocols to produce premium, hormone-free milk." 
  },
  { 
    number: "03", 
    title: "Manure Processing", 
    desc: "Livestock manure is systematically collected and composted, transforming waste into high-value organic fertilizer." 
  },
  { 
    number: "04", 
    title: "Soil Restoration", 
    desc: "Processed organic fertilizer is returned directly to fields, replenishing nutrients and closing the loop." 
  },
];
    ...
    <section className="w-full bg-white">
      <div className="container-pad py-24">
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center lg:gap-24">
          ...
          >
            <h2 className="font-heading text-3xlxl font-bold leading-tight text-[#1C2321] sm:text-4xl">
