        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center lg:gap-16">
          ...
          <div>
            ...
            <h2 className="font-heading text-3xl font-bold leading-tight text-[#1C2321] sm:text-4xl">
              A Dairy System Built on<br />
              <span className="text-[#3A7D5A]">Sustainable Principles.</span>
            </h2>
            <p className="mt-5 text-[15px] font-body leading-relaxed text-[#6B6259]">
              Every element of our dairy operation is integrated into a closed-loop system guided by climate-smart farming and sustainable resource management. Manure becomes fertilizer, crops become feed, renewable energy is recovered, and the land is continuously restored — season after season.
            </p>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="flex flex-col gap-3">
              <div className="relative h-36 w-full overflow-hidden rounded-xl">
                <Image src="/images/dairy/organic-manure.png" alt="Dairy barn at Ingaju Farms" fill sizes="25vw" className="object-cover" />
              </div>
              <div className="relative h-56 w-full overflow-hidden rounded-xl sm:h-64">
                <Image src="/images/dairy/cow-3.png" alt="Farmer caring for livestock" fill sizes="25vw" className="object-cover" />
              </div>
            </div>
          </div>
