...
const STEPS = [
  { 
    number: "01", 
    title: "Forage & Feed Production", 
    desc: "We cultivate high-quality, climate-smart fodder on-site, ensuring consistent, traceable nutrition year-round while eliminating reliance on costly commercial feed." 
  },
  { 
    number: "02", 
    title: "Dairy Herd Management", 
    desc: "Our well-nourished cattle are managed under strict welfare and preventive health protocols to produce premium, hormone-free milk and quality breeding stock." 
  },
  { 
    number: "03", 
    title: "Manure Processing", 
    desc: "Livestock manure is systematically collected and processed through controlled composting, transforming operational waste into a high-value asset." 
  },
  { 
    number: "04", 
    title: "Soil Restoration", 
    desc: "The processed organic fertilizer is returned directly to our fields, replenishing soil nutrients and fully closing the zero-waste agricultural loop." 
  },
];
