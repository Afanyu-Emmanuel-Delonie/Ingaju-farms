...
export default function AboutHero() {
  return (
    <section className="relative w-full h-[70vh] lg:h-[60vh] overflow-hidden bg-[#1C2321] flex items-end">
      ...
      <div className="relative z-10 container-pad pb-12 w-full">
        <span className="mb-4 inline-block rounded-full bg-[#3A7D5A]/20 border border-[#3A7D5A]/30 px-4 py-1.5 text-xs font-body font-semibold uppercase tracking-widest text-[#6DBE8C]">
          About Ingaju Farms
        </span>
        <h1 className="max-w-3xl text-4xl font-heading font-bold leading-tight text-white md:text-5xl lg:text-6xl">
          Growing More.<br />
          <span className="text-[#6DBE8C]">Than Just Food.</span>
        </h1>
        <p className="mt-4 max-w-2.5xl text-base leading-relaxed text-white/60 md:text-lg">
