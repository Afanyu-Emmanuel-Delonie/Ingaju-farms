...
<p className="mt-4 text-[15px] font-body leading-relaxed text-[#6B6259]">
  Every element of our dairy operation is monitored and integrated into a zero-waste loop. By combining effective management with continuous data collection, we optimize resource conversion—maximizing operational efficiency and predictability season after season.
</p>
