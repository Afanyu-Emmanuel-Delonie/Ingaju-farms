...
const categories = [
  {
    ...
    description:
      "Fresh milk, organic manure, and quality breeding livestock produced through responsible farm management and circular farming practices.",
  ...
  },
  {
    ...
    description:
      "Naturally grown corn, beans & soybeans, and nuts cultivated using sustainable farming methods that support healthy soil and quality harvests.",
  ...
  },
  {
    ...
    description:
      "Strong and well-managed livestock raised to support productivity and genetic improvement for farmers and livestock enterprises.",
    ctaLabel: "Explore Market Place",
    ctaHref: "/marketplace",
    image: "/images/bg-3.png",
    alt: "Bottles of fresh milk on a wooden table",
  },
  {
    key: "trainings",
