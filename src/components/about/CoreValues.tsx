...
const values = [
 ...
 { title: "Innovation", description: "Embracing climate-smart agriculture and practical, on-farm problem-solving that improves efficiency, quality, and resilience season after season.", icon: Lightbulb },
