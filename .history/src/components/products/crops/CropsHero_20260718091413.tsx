...
export default function CropsHero() {
  ...
  We cultivate premium food and feed crops using organic soil management and integrated pest control. By relying on climate-smart agronomy instead of synthetic chemicals, we build long-term land productivity and absolute crop traceability.
</p>
