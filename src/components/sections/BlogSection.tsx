  ...
  return (
    <section className="w-full bg-[#FAF8F5]">
      <div className="container-pad py-20">
        <div>
            <p className="text-sm font-body font-semibold tracking-widest uppercase text-[#2E4F41]">Our Blog</p>
            ...
            <a key={post.slug} href={`/blog/${post.slug}`} className="group flex flex-col overflow-hidden rounded-2xl bg-white shadow-sm transition-shadow hover:shadow-md">
              ...
              <div className="flex flex-1 flex-col p-5">
                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <span className="inline-flex items-center gap-1 text-xs font-body font-medium text-[#1C2321] group-hover:text-[#2E4F41] transition-colors">Read More <ArrowRight className="h-3 w-3" /></span>
                </div>
              </div>
            </a>
          ))}
