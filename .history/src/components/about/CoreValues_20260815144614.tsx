...
const values = [
 ...
 { title: "Innovation", description: "Embracing climate-smart agriculture today, and building toward renewable energy and digital farm-management and tracking systems that improve efficiency, quality, and resilience.", icon: Lightbulb }{ title: "Integrity", description: "Operating with honesty, transparency, and accountability across all processes, from farm to market.", icon: ShieldCheck },
