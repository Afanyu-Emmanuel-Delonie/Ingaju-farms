          ...
          {trainings.map((item) => (
            ...
            >
              ...
              <div className="flex flex-1 flex-col p-5">
                ...
                <a
                  href={item.ctaHref}
                  className="mt-5 inline-flex w-f items-center justify-center rounded-full border border-[#E0D8CE] px-6 py-2.5 text-sm font-body font-medium text-[#1C2321] transition-colors hover:bg-[#F0EBE3]"
                >
                  {item.ctaLabel}
                </a>
              </div>
