  ...
  return (
    ...
    >
      <div className="container-pad grid grid-cols-1 md:grid-cols-[1fr_1.5fr] gap-12 md:gap-16 items-center min-h-[320px]">
        ...
        <div>
          <h2 className="text-3xl md:text-4xl font-heading font-medium text-[#1C2321] leading-tight">
        ...
        <div>
          ...
          <div key={animKey} className="animate-fade-up">
            <p className="text-base md:text-lg font-heading font-normal leading-relaxed text-[#1C2321] line-clamp-2">
              {t.quote}
            </p>
