    ...
    <section className="w-full bg-[#F9F6F0]">
      <div className="container-pad py-20">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
          <div className="relative h-72 w-full overflow-hidden lg:h-72 rounded-2xl">
            <Image
              src="/images/bg-3.png"
          ...
          <div className="flex h-72 w-full flex-col justify-end bg-[#D07A53] p-6 text-white lg:h-72">
          ...
          <div className="relative h-72 w-full overflow-hidden lg:h-72">
            <Image
              src="/images/bg-2.png"
          ...
          <div className="flex h-72 w-full flex-col justify-end bg-[#2E4F41] p-6 text-white lg:h-72">
            <span className="text-4xl font-bold leading-none sm:text-5xl">
              500+
            </span>
            <p className="mt-3 text-sm font-semibold tracking-wide uppercase">
