...
export default function CircularHero() {
  ...
  At Ingaju Farms, every operational output acts as a high-value input for another. Through data-driven asset conversion, our closed-loop ecosystem eliminates waste and cuts costs while maximizing predictable agricultural yields.
</p>
