        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center lg:gap-24">
          ...
          >
            ...
            <p className="mt-5 text-[15px] font-body leading-relaxed text-[#6B6259] max-w-lg">
              > Unlike conventional farms reliant on costly inputs, Ingaju operates a closed loop where every output becomes a next-stage input—eliminating waste and driving down costs
            </p>
            {/* Loop steps */}
