...
import { STAGE_DATA, STAGE_ORDER, type StageKey } from "@/lib/constants";
...
const ARC_R = NODE_ORBIT_R + NODE_R - 8; // slightly inside the outer edge of the node circles
        ...
        >
          ...
          {STAGE_ORDER.map((key) => {
            ...
            return (
              ...
              >
                {/* Photo */}
                <div className="relative h-[65%] w-full flex-shrink-0">
                ...
                >
                  <span
                    ...
                    style={{ fontSize: "clamp(8.5px, 2vw, 8px)" }}
                  >
                    {s.label}
                  </span>
                </div>
