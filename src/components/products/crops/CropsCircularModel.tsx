        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center lg:gap-16">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="flex flex-col gap-3">
              <div className="relative h-56 w-full overflow-hidden rounded-xl sm:h-64">
                <Image src="/images/bg-img.png" alt="Corn growing in rich organic soil" fill sizes="25vw" className="object-cover" />
              </div>
              <div className="relative h-36 w-full overflow-hidden rounded-xl">
                <Image src="/images/bg-2.png" alt="Harvested beans at Ingaju Farms" fill sizes="25vw" className="object-cover" />
              </div>
            </div>
            <div className="flex flex-col gap-3">
              <div className="relative h-36 w-full overflow-hidden rounded-xl">
              ...
              <div className="relative h-56 w-full overflow-hidden rounded-xl sm:h-64">
                <Image src="/images/bg-img.png" alt="Farmer tending crop rows" fill sizes="25vw" className="object-cover" />
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <h2 className="font-heading text-3xl font-bold leading-tight text-[#1C2321] sm:text-4xl">
              ...
              <span className="text-[#2E4F41]">Not by Chemicals.</span>
            </h2>
