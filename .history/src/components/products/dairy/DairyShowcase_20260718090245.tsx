...
const PRODUCTS = [
  {
    ...
    title: "Fresh Milk",
    unit: "liters",
    desc: "Produced from pasture-raised, hormone-free cattle managed under climate-smart husbandry protocols. Consistent quality, rigorous hygiene standards, and full traceability from herd to delivery.",
  ...
  },
  {
    ...
    unit: "kg",
    desc: "High-quality compost and bioslurry derived from livestock manure through controlled composting and anaerobic digestion — a nutrient-rich, pathogen-reduced soil amendment for sustainable crop production.",
  ...
  },
  {
    ...
    unit: "head",
    desc: "Genetically sound, disease-free breeding bulls raised under welfare-oriented management for superior dairy and beef performance. Sourced to support herd genetic improvement and long-term productivity.",
