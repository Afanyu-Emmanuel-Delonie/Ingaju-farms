    ...
    <section className="relative w-full h-[80vh] min-h-[500px] overflow-hidden bg-[#1C2321] flex items-end">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <h1 className="max-w-4xl text-3xl font-heading font-bold leading-tight text-white md:text-5xl">
          Data-driven, climate-smart agribusiness in Rwanda
          <span className="text-[#6DBE8C]"> agribusiness in Rwanda</span>
        </h1>
        
        <p className="mt-4 max-w-2xl font-body text-base leading-relaxed text-white/80 md:text-lg">
          We combine dairy farming, crop cultivation, and organic recycling with data-driven management and capacity building to scale profitable, climate-smart agriculture in Rwanda.
        </p>
