        ...
        <motion.div variants={container(0.15)} initial="hidden" whileInView="show" viewport={{ once: true, margin: "-8%" }} className="grid grid-cols-1 gap-10 pb-20 md:grid-cols-2 md:gap-16 items-center">
          ...
          <motion.div variants={item} className="flex flex-col justify-center">
            <p className="text-[15px] font-body leading-relaxed text-[#6B6259]">
              We operate a closed-loop agribusiness in Rwanda that integrates dairy farming and crop cultivation. By combining strict data record-keeping with circular practices, we optimize farm efficiency. We recycle livestock manure into high-quality organic fertilizer, eliminating expensive synthetic inputs, lowering production costs, and actively restoring soil health.
            </p>
            <a
              href="/about"
