        ...
        <div className="mt-10 grid grid-cols-1 gap-4">
          ...
          >
            ...
            <p className="mt-2 text-sm font-body leading-relaxed text-white/75">
                Fresh milk and quality breeding livestock produced under welfare-oriented management, balanced nutrition protocols, and preventive animal health programmes — with no synthetic hormones or growth promoters. Raised through climate-smart husbandry practices that protect animal welfare and reduce the farm's environmental footprint.
              </p>
