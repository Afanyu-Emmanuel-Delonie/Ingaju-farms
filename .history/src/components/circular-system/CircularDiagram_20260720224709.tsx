            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  className="flex flex-1 w-full flex-col items-center justify-center gap-1 bg-[#3A7D5A] px-[10%]"
                >
                  <Icon className="h-[clamp(10px,2.2vw,16px)] w-[clamp(10px,2.2vw,16px)] text-white" />
                  <span
