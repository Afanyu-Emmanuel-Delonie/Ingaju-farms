...
export default function CircularHero() {
  ...
  By merging effective management with data-driven precision, our closed-loop ecosystem converts operational waste into premium agricultural assets to maximize predictability and yield.
</p>
