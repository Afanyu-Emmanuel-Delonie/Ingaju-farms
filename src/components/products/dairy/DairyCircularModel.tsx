      ...
      <div className="container-pad py-20">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center lg:gap-16">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="flex flex-col gap-3">
              <div className="relative h-36 w-full overflow-hidden rounded-xl">
                <Image src="/images/manure.jpg" alt="Dairy barn at Ingaju Farms" fill sizes="25vw" className="object-cover" />
              </div>
              <div className="relative h-56 w-full overflow-hidden rounded-xl sm:h-64">
                <Image src="/images/cow-2.png" alt="Farmer caring for livestock" fill sizes="25vw" className="object-cover" />
              </div>
            </div>
          </div>
