...
const IMAGES = [
  ...
  { src: "/images/circular-system/milking.png", alt: "Milking operations" },
  { src: "/images/about/about-2.png", alt: "Farm operations" },
  { src: "/images/circular-system/organic Manure.png", alt: "Organic fertilizer composting" },
  { src: "/images/crops/maiz-harvest.png", alt: "Maize harvest" },
  { src: "/images/dairy/dairy-production.png", alt: "Dairy production" },
  { src: "/images/about/about-3.png", alt: "On the farm" },
  { src: "/images/circular-system/milling.png", alt: "Feed milling" },
