      ...
      <div className="w-full max-w-md">
        <div className="relative overflow-hidden rounded-3xl bg-[#1C2321] p-8 sm:p-10 shadow-2xl">
          ...
          <div className="relative z-10">
            ...
            <h1 className="font-heading text-2xl font-bold text-white leading-snug mb-2">Sign in to continue</h1>
            ...
            <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4">
              ...
              >
                {busy ? (
                  ...
                  <><div className="w-4 h-4 rounded-full bg-white/20 flex items-center justify-center"><svg className="w-2.5 h-2.5 text-white" fill="none" viewBox="0 0 12 12"><path d="M2 6l3 3 5-5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg></div>Redirecting...</>
                ) : (
        ...
        <p className="mt-6 text-center text-xs font-body text-[#6B6259]">
          Need access? Contact <span className="text-[#3A7D5A] font-semibold">support@ingajufarms.com</span>
        </p>
      </div>
    </div>
  );
