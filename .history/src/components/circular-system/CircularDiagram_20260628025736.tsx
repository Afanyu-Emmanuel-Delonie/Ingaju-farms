...
export default function CircularDiagram() {
  ...
  return (
    <section id="the-loop" ref={sectionRef} className="w-full bg-[#F8F6F2]">
      <div className="container-pad py-24">
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center lg:gap-20">
          ...
          <div ref={imgRef} className="relative h-[520px] w-full overflow-hidden rounded-3xl">
            ...
            />
            {/* Overlay badge */}
            <div className="absolute bottom-6 left-6 rounded-2xl border border-white/20 bg-[#0a0f0d]/70 backdrop-blur-sm px-5 py-4">
              <p className="font-heading text-lg font-bold text-white">Zero Waste System</p>
              <p className="mt-1 text-xs font-body text-white/65">Every output becomes an input.</p>
            </div>
          </div>
