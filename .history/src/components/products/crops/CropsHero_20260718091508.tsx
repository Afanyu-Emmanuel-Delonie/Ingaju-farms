...
export default function CropsHero() {
  ...
  Driven by climate-smart agronomy, our integrated crop system relies on organic soil management to eliminate synthetic chemicals and deliver premium, fully traceable yields.
</p>
